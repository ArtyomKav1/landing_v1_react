...
import item_1_img_1 from '../assets/item_1/1.png';
import item_1_img_2 from '../assets/item_1/2.png';
import item_1_img_V from '../assets/item_1/screen_video_1.png';
import item_2_img_1 from '../assets/item_2/1.png';
import item_2_img_2 from '../assets/item_2/2.png';
import item_2_img_V from '../assets/item_2/csreen_video_2.png';
import item_3_img_1 from '../assets/item_3/1.png';
import item_3_img_2 from '../assets/item_3/2.png';
...
const data = [
  {
    ...
    video_link: 'https://pravo.tech/documents/universe/1.mp4',
  },
  {
    text1_main: '25%',
    ...
    text2_2:
      'Посмотрите, как ИТ - решения освобождают время для громких побед в судебных процессах.',
    img_1: item_2_img_1,
    img_2: item_2_img_2,
    img_V: item_2_img_V,

    video_link: 'https://pravo.tech/documents/universe/2.mp4',
  },
  {
    text1_main: '21%',
    ...
    img_2: item_3_img_2,
    img_V: item_3_img_V,
    video_link: 'https://pravo.tech/documents/universe/3.mp4',
  },
];
function Main() {
  return (
    <>
      <div className="overflow-x-hidden">
        {data.map((item, index) => (
          <div key={index}>
            <MainItem
              text1_main={item.text1_main}
              text1_sub={item.text1_sub}
              text1_sub_col={item.text1_sub_col}
              text2_1={item.text2_1}
              text2_1_col={item.text2_1_col}
              text2_2={item.text2_2}
              img1={item.img_1}
              img2={item.img_2}
              imgV={item.img_V}
